...
RSpec.describe 'Follows', type: :request do
  ...
  describe 'POST /api/follows' do
    ...
    context 'when authorized' do
      ...
      it { expect(JSON.parse(subject.body, symbolize_names: true)).to eq id: Follow.last.id, target: { id: Follow.last.target.id, nickname: Follow.last.target.nickname, icon_thumb_url: Follow.last.target.icon_url(:thumb) } }
    end
  end
