...
RSpec.describe 'Users', type: :request do
  ...
  describe 'GET /api/users/#{id}' do
    ...
    context 'when not empty' do
      ...
      it { is_expected.to have_http_status :ok }
      it { expect(JSON.parse(subject.body, symbolize_names: true)).to eq id: user.id, nickname: user.nickname, biography: user.biography, icon_url: user.icon_url, icon_thumb_url: user.icon_url(:thumb), is_block: false, block: nil, follow: nil, is_follower: false }
    end
    context 'when is block' do
      ...
      it { is_expected.to have_http_status :ok }
      it { expect(JSON.parse(subject.body, symbolize_names: true)).to eq id: user.id, nickname: user.nickname, biography: user.biography, icon_url: user.icon_url, icon_thumb_url: user.icon_url(:thumb), is_block: true, block: block.id, follow: nil, is_follower: false }
    end
    context 'when is follow' do
      ...
      it { is_expected.to have_http_status :ok }
      it { expect(JSON.parse(subject.body, symbolize_names: true)).to eq id: user.id, nickname: user.nickname, biography: user.biography, icon_url: user.icon_url, icon_thumb_url: user.icon_url(:thumb), is_block: false, block: nil, follow: follow.id, is_follower: false }
    end
    context 'when is follower' do
      ...
      it { is_expected.to have_http_status :ok }
      it { expect(JSON.parse(subject.body, symbolize_names: true)).to eq id: user.id, nickname: user.nickname, biography: user.biography, icon_url: user.icon_url, icon_thumb_url: user.icon_url(:thumb), is_block: false, block: nil, follow: nil, is_follower: true }
    end
